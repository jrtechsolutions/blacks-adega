...
router.use('/admin', (0, role_1.authorizeRoles)('ADMIN', 'VENDEDOR'), admin_2.default);
router.use('/motoboy', motoboy_2.motoboyMiddleware, motoboy_1.default);
router.use('/vendedor', vendedor_1.default);
...
router.use('/admin/doses', (0, role_1.authorizeRoles)('ADMIN', 'VENDEDOR'), dose_routes_1.default);
router.use('/admin', (0, role_1.authorizeRoles)('ADMIN', 'VENDEDOR'), comanda_1.default);
