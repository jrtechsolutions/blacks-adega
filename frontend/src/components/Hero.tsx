...
const Hero = () => {
  return (
    <div className="bg-gradient-to-r from-element-black to-element-gray-dark text-white">
      <div className="element-container py-16 md:py-24">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 animate-fade-in">
              Bem-vindo à <span className="text-element-gold">Element Adega</span>
            </h1>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-lg shadow-lg animate-fade-in" style={{animationDelay: '0.6s'}}>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div className="flex flex-col items-center text-center element-card-hover">
                  <div className="bg-element-gold rounded-full p-4 mb-4">
                    <Beer className="h-10 w-10 text-element-black" />
                  </div>
                ...
                <div className="flex flex-col items-center text-center element-card-hover">
                  <div className="bg-element-gold rounded-full p-4 mb-4">
                    <Package className="h-10 w-10 text-element-black" />
                  </div>
                ...
                <div className="flex flex-col items-center text-center element-card-hover">
                  <div className="bg-element-gold rounded-full p-4 mb-4">
                    <Cigarette className="h-10 w-10 text-element-black" />
                  </div>
