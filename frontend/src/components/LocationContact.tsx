...
const ContactItem = ({ icon, title, content }: { icon: React.ReactNode, title: string, content: React.ReactNode }) => {
  return (
    <div className="flex items-start p-4 rounded-lg bg-element-white shadow-sm hover:shadow-md transition-shadow">
      <div className="rounded-full bg-element-gold p-3 mr-4">
        {icon}
      </div>
      <div>
        <h3 className="font-bold mb-1 text-element-black">{title}</h3>
        {content}
      </div>
    </div>
  );
      ...
      <div className="element-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            <ContactItem 
              icon={<MapPin className="h-6 w-6 text-element-black" />}
              title="Endereço"
              content={
            ...
            <ContactItem 
              icon={<Phone className="h-6 w-6 text-element-black" />}
              title="Telefone"
              content={
                <p className="text-element-black">
            ...
            <ContactItem 
              icon={<Clock className="h-6 w-6 text-element-black" />}
            ...
            <ContactItem 
              icon={<Truck className="h-6 w-6 text-element-black" />}
              title="Entrega"
              content={
                <p className="text-element-black">
                  Máx 5 km
