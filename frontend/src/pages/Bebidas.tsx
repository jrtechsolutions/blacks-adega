...
const ProductCard = ({ product }: { product: any }) => {
  return (
    <Card className="overflow-hidden transition-all duration-300 hover:shadow-lg border-element-gray hover:border-element-wine h-full flex flex-col">
      <AspectRatio ratio={4/3} className="bg-element-white">
        <img 
      ...
      <CardContent className="p-4 flex-grow flex flex-col">
        <h3 className="font-bold text-lg mb-1 text-element-black flex-grow">{product.name}</h3>
        <p className="text-element-black/80 text-sm mb-3 min-h-[40px]">{product.description}</p>
        
        <div className="flex items-end justify-between mt-auto">
          <div>
            <p className="text-element-black font-bold text-xl">R$ {product.price?.toFixed(2)}</p>
            {product.originalPrice && (
              <p className="text-element-black/60 text-sm line-through">R$ {product.originalPrice.toFixed(2)}</p>
            )}
          </div>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-element-black to-element-gold text-white py-12 md:py-16">
          <div className="element-container">
            <div className="max-w-3xl mx-auto text-center">
              <Badge className="mb-4 bg-element-white text-element-black hover:bg-element-white">
        ...
        <section className="bg-element-gray py-6">
          <div className="element-container">
              ...
              <div className="flex gap-2 w-full md:w-auto">
                <div className="relative flex-1 md:w-72">
                  <Input
                    ...
                    className="pl-8"
                  />
                  <Search className="absolute left-2.5 top-2.5 h-4 w-4 text-element-black/50" />
                </div>
            ...
            {showFilters && (
              <div className="bg-element-white p-4 rounded-md mb-6 animate-fade-in">
                ...
                <div className="px-3">
                  <Slider
                    ...
                    className="mb-6"
                  />
                  <div className="flex justify-between text-sm text-element-black">
            ...
            >
              <TabsList className="grid grid-cols-2 md:grid-cols-6 mb-6 bg-element-white overflow-x-auto">
        ...
        <section className="py-8 md:py-12 bg-element-white">
          <div className="element-container">
            {filteredProducts.length > 0 ? (
              ...
              <div className="text-center py-12">
                <h3 className="text-xl font-bold text-element-black">Nenhum produto encontrado</h3>
                <p className="text-element-black/70 mt-2">Tente ajustar sua busca ou filtros</p>
              </div>
            )}
          </div>
        </section>
