  ...
  return (
    <div className="element-card p-6">
      <div className="flex items-center justify-between mb-4">
        <div className="bg-element-gray rounded-lg p-3">
          {icon}
        </div>
        {change && (
      ...
      <h3 className="text-element-black/70 text-sm mb-1">{title}</h3>
      <p className="text-2xl font-bold text-element-black">{value}</p>
    </div>
  );
};
...
const VendedorDashboard = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-element-gray flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-element-black mx-auto mb-4"></div>
          <p className="text-element-black">Carregando dashboard...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-element-gray">
      <div className="lg:pl-64 min-h-screen">
        <div className="p-4 md:p-6 lg:p-8">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-2xl md:text-3xl font-bold text-element-black mb-2">
              Dashboard do Vendedor
            </h1>
            <p className="text-element-black">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <Link to="/vendedor/estoque" className="element-card p-6 hover:shadow-lg transition-shadow">
              <div className="flex items-center mb-4">
                <Archive className="h-8 w-8 text-element-black mr-3" />
                <h3 className="text-lg font-semibold text-element-black">Consultar Estoque</h3>
              </div>
              <p className="text-element-black/70 text-sm">
            ...
            <Link to="/vendedor/produtos" className="element-card p-6 hover:shadow-lg transition-shadow">
              <div className="flex items-center mb-4">
                <Package className="h-8 w-8 text-element-black mr-3" />
                <h3 className="text-lg font-semibold text-element-black">Cadastrar Produtos</h3>
              </div>
              <p className="text-element-black/70 text-sm">
            ...
            <Link to="/vendedor/pdv" className="element-card p-6 hover:shadow-lg transition-shadow">
              <div className="flex items-center mb-4">
                <ShoppingCart className="h-8 w-8 text-element-black mr-3" />
                <h3 className="text-lg font-semibold text-element-black">PDV</h3>
              </div>
              <p className="text-element-black/70 text-sm">
          ...
          <div className="element-card p-6 mb-8">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-semibold text-element-black">Produtos com Estoque Baixo</h2>
              <Link to="/vendedor/estoque" className="element-link text-sm">Ver todos</Link>
            </div>
            <div className="space-y-4">
              {lowStockProducts.length === 0 ? (
                <p className="text-element-black text-center py-8">
                  Nenhum produto com estoque baixo
                </p>
              ) : (
                lowStockProducts.slice(0, 5).map((product) => (
                  <div key={product.id} className="flex items-center justify-between p-3 bg-element-gray/50 rounded-lg">
                    <div className="flex items-center">
                      <div className={`w-3 h-3 rounded-full mr-3 ${product.stock < 2 ? 'bg-red-500' : 'bg-orange-500'}`}></div>
                      <div>
                        <h4 className="font-medium text-element-black">{product.name}</h4>
                        <p className="text-sm text-element-black/70">
          ...
          <div className="element-card p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-semibold text-element-black">Vendas Recentes</h2>
              ...
              <table className="min-w-full">
                <thead>
                  <tr className="border-b border-element-gray">
                    ...
                    <th className="py-3 text-left text-sm font-medium text-element-black/70">Data</th>
                  </tr>
                </thead>
                <tbody>
                  {sales.slice(0, 5).map((sale) => (
                    <tr key={sale.id} className="border-b border-element-gray">
