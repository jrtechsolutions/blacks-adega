...
const Narguile = () => {
  ...
  const ProductCard = ({ product }: { product: any }) => {
    return (
      <Card className="overflow-hidden transition-all duration-300 hover:shadow-lg border-element-gray-light hover:border-element-gold h-full flex flex-col">
        ...
        <CardContent className="p-4 flex-grow">
          <h3 className="font-bold text-lg mb-1 text-element-black">{product.name}</h3>
          <p className="text-element-gray-dark/80 text-sm mb-3 min-h-[40px]">{product.description}</p>
          <div className="flex items-end justify-between">
            <div>
              <p className="text-element-black font-bold text-xl">R$ {typeof product.price === 'string' ? product.price : product.price?.toFixed(2)}</p>
            </div>
          </div>
        </CardContent>
      </Card>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-element-black to-element-gray-dark text-white py-12 md:py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <Badge className="mb-4 bg-element-gold text-element-gray-dark hover:bg-element-gold animate-pulse-soft">
        ...
        {featuredProducts.length > 0 && (
          <section className="py-10 bg-element-gray-light">
            <div className="container mx-auto px-4">
              <h2 className="text-2xl font-bold mb-6 text-element-black">Destaques em Narguilé</h2>
        ...
        <section className="bg-white py-6 sticky top-0 z-10 shadow-sm">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-center mb-4">
              <h2 className="text-2xl font-bold mb-4 md:mb-0 text-element-black">Produtos para Narguilé</h2>
              ...
              <div className="flex gap-2 mb-6">
                {categoriasFiltro.map((cat) => (
                  <Button
                    ...
                    className={activeCategory === cat.value ? 'bg-element-black text-white' : ''}
                  >
                    {cat.label}
                  </Button>
                ))}
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg text-center">
                <div className="w-12 h-12 bg-element-gold rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        {/* Call to Action */}
        <section className="bg-element-black py-8 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <Link to="/login" className="inline-flex items-center bg-element-gold text-element-gray-dark px-6 py-3 rounded-lg font-medium hover:bg-element-gold/80 transition-colors">
