...
const AdminCashRegister = () => {
  ...
  return (
    <AdminLayout noPadding={true}>
      <div className="flex flex-col h-screen w-full bg-[#0B0B0B]">
        {/* Header */}
        <div className="bg-[#1F1F1F] border-b border-[#2E2E2E] shadow-sm p-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <ShoppingCart className="h-6 w-6 text-[#D4AF37]" />
            <h1 className="text-xl font-medium text-[#FFFFFF]">Caixa Administrativo</h1>
          </div>
          <Button 
