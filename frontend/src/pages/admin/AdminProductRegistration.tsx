    ...
    <AdminLayout>
      <div className="w-full">
        <div className="p-4 md:p-6 lg:p-8 w-full">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-[#FFFFFF]">Cadastro de Produtos</h1>
            <p className="text-[#CFCFCF]">
              Cadastre novos produtos para o estoque da Black's Adega.
            </p>
          </div>
          
          <div className="bg-[#1F1F1F] border border-[#2E2E2E] p-6 rounded-lg shadow-sm">
          <Form {...form}>
                      ...
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                        <FormControl>
                          <input
                            ...
                            className="h-4 w-4 rounded border-gray-300 text-element-black focus:ring-element-black"
                          />
                        </FormControl>
