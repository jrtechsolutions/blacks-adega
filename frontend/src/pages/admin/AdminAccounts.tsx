...
const AdminAccounts = () => {
  ...
  return (
    <AdminLayout>
      <div className="flex h-screen bg-element-white">
        <div className="flex-1 p-6 overflow-y-auto ml-0 lg:ml-64">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold text-element-black">Contas a Pagar</h1>
            <Button className="bg-element-gold text-element-black hover:bg-element-gold/80">
