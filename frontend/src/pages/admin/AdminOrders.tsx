        ...
        <div className="p-4 md:p-6 lg:p-8 w-full">
          ...
          <div className="mb-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-[#FFFFFF] mb-1">Gerenciar Pedidos</h1>
                <p className="text-[#CFCFCF]">Visualize e gerencie todos os pedidos realizados</p>
              </div>
              <Button 
                className="mt-4 md:mt-0 bg-[#D4AF37] hover:bg-[#E6C76A] text-[#0B0B0B]" 
              ...
              <div className="col-span-1 md:col-span-2">
                <div className="relative">
                  ...
                  <Input 
                    ...
                    className="pl-10 bg-[#1F1F1F] border-[#2E2E2E] text-[#FFFFFF] placeholder:text-[#CFCFCF]"
                  />
                </div>
              </div>
              ...
              <div className="col-span-1">
                <div className="flex items-center space-x-2">
                  ...
                  <Input
                    type="date"
                    id="date"
                    className="flex-1 bg-[#1F1F1F] border-[#2E2E2E] text-[#FFFFFF] focus:ring-2 focus:ring-[#D4AF37]"
                  />
                </div>
              </div>
            </div>
          ...
          <Tabs defaultValue="all" value={currentTab} onValueChange={setCurrentTab} className="mb-6">
            <TabsList className="grid grid-cols-3 md:grid-cols-6 gap-2 bg-[#1F1F1F] border border-[#2E2E2E]">
              <TabsTrigger value="all" className="text-sm text-[#CFCFCF] data-[state=active]:bg-[#D4AF37] data-[state=active]:text-[#0B0B0B]">Todos</TabsTrigger>
              <TabsTrigger value="pending" className="text-sm text-[#CFCFCF] data-[state=active]:bg-[#D4AF37] data-[state=active]:text-[#0B0B0B]">Pendentes</TabsTrigger>
              <TabsTrigger value="preparing" className="text-sm text-[#CFCFCF] data-[state=active]:bg-[#D4AF37] data-[state=active]:text-[#0B0B0B]">Preparando</TabsTrigger>
              <TabsTrigger value="delivering" className="text-sm text-[#CFCFCF] data-[state=active]:bg-[#D4AF37] data-[state=active]:text-[#0B0B0B]">Em entrega</TabsTrigger>
              <TabsTrigger value="delivered" className="text-sm text-[#CFCFCF] data-[state=active]:bg-[#D4AF37] data-[state=active]:text-[#0B0B0B]">Entregues</TabsTrigger>
              <TabsTrigger value="cancelled" className="text-sm text-[#CFCFCF] data-[state=active]:bg-[#D4AF37] data-[state=active]:text-[#0B0B0B]">Cancelados</TabsTrigger>
            </TabsList>
          </Tabs>
          
          {/* Orders table */}
          <div className="bg-[#1F1F1F] border border-[#2E2E2E] rounded-lg shadow overflow-hidden">
            <Table>
              <TableCaption className="text-[#CFCFCF]">
              ...
              <TableHeader>
                <TableRow className="border-[#2E2E2E]">
                  <TableHead className="text-[#FFFFFF]">ID</TableHead>
                  <TableHead className="text-[#FFFFFF]">Cliente</TableHead>
                  <TableHead className="text-[#FFFFFF]">Data</TableHead>
                  <TableHead className="text-[#FFFFFF]">Total</TableHead>
                  <TableHead className="text-[#FFFFFF]">Status</TableHead>
                  <TableHead className="text-right text-[#FFFFFF]">Ações</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {paginatedOrders.map((order) => (
                  <TableRow key={order.id} className="border-[#2E2E2E] hover:bg-[#2E2E2E]">
                    <TableCell className="font-medium text-[#FFFFFF]">{order.id}</TableCell>
                    <TableCell className="text-[#CFCFCF]">{order.customer}</TableCell>
                    <TableCell>
                      <div className="flex flex-col">
                        <span className="text-[#FFFFFF]">{formatDate(order.timestamp)}</span>
                        <span className="text-xs text-[#CFCFCF]">{formatTime(order.timestamp)}</span>
                      </div>
                    </TableCell>
                    <TableCell className="text-[#FFFFFF]">R$ {order.total.toFixed(2)}</TableCell>
