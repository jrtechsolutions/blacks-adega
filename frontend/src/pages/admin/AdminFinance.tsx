      ...
      <AdminLayout>
        <div className="flex items-center justify-center h-full">
          <div className="text-center">
            ...
            <p className="mt-4 text-[#CFCFCF]">Carregando relatório financeiro...</p>
          </div>
        </div>
      </AdminLayout>
    );
      ...
      <div className="w-full">
        ...
        <div className="mb-6">
          <div className="flex flex-wrap items-center gap-2 bg-[#1F1F1F] border border-[#2E2E2E] p-3 rounded-lg shadow-sm">
            ...
            <Button onClick={handleDateFilter} className="ml-2 bg-[#D4AF37] hover:bg-[#E6C76A] text-[#0B0B0B]">
              Filtrar
            </Button>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex justify-between items-center py-2 border-b border-[#2E2E2E]/10">
              ...
              <div className="flex justify-between items-center py-2 pt-4 border-t-2 border-[#2E2E2E]/20">
