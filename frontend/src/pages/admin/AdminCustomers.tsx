      ...
      <div className="w-full">
        <div className="p-4 md:p-6 lg:p-8 w-full">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold text-[#FFFFFF]">Lista de Clientes</h1>
            <Button className="bg-[#D4AF37] text-[#0B0B0B] hover:bg-[#E6C76A]" onClick={openNew}>
              + Novo Cliente
            </Button>
          </div>
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <div className="flex gap-4">
              ...
              <Button className="bg-element-black">
