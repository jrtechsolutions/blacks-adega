    ...
    <AdminLayout>
      <div className="w-full">
        <div className="p-4 md:p-6 lg:p-8 w-full">
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-[#FFFFFF]">Combos, Promoções e Doses</h1>
            <p className="text-[#CFCFCF]">Gerencie combos, promoções e doses do catálogo.</p>
          </div>
          <Tabs defaultValue="combos" className="w-full" onValueChange={clearSearches}>
            ...
            <TabsContent value="combos">
              <div className="flex flex-col sm:flex-row sm:justify-between mb-4 gap-2">
                <div className="flex items-center gap-2 w-full sm:w-80">
                  ...
                  <Input
                    ...
                    className="flex-1 bg-[#1F1F1F] border-[#2E2E2E] text-[#FFFFFF] placeholder:text-[#CFCFCF]"
                  />
                </div>
                <Button className="flex items-center gap-2 w-full sm:w-auto bg-[#D4AF37] hover:bg-[#E6C76A] text-[#0B0B0B]" onClick={() => { resetForm(); setIsComboDialogOpen(true); }}>
              ...
              <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
                {(filteredCombos || []).map((combo) => (
                  <Card key={combo.id} className="min-h-[200px] shadow-lg border-2 border-[#2E2E2E] bg-[#1F1F1F] hover:border-[#D4AF37] transition-all group">
                    <CardHeader className="pb-2">
                      <div className="flex justify-between items-start gap-4">
                        <div className="flex-1">
                          <CardTitle className="text-xl font-bold text-[#FFFFFF] group-hover:text-[#D4AF37] transition-colors">{combo.name}</CardTitle>
                          <CardDescription className="text-[#CFCFCF] mt-1">{combo.description}</CardDescription>
                        ...
                        <div className="space-y-1">
                          {combo.items.map((item) => (
                            <div key={item.id} className="flex items-center gap-2 text-sm">
                              <span className="font-medium text-[#FFFFFF]">{item.product.name}</span>
                              <span className="text-[#CFCFCF]">({item.quantity})</span>
                              {item.allowFlavorSelection && <Tag className="w-3 h-3 text-[#D4AF37]" />}
                            </div>
                          ))}
                        </div>
                      </div>
            ...
            <TabsContent value="promotions">
              <div className="flex flex-col sm:flex-row sm:justify-between mb-4 gap-2">
                ...
                <Button className="flex items-center gap-2 w-full sm:w-auto bg-[#D4AF37] hover:bg-[#E6C76A] text-[#0B0B0B]" onClick={() => { resetForm(); setIsPromotionDialogOpen(true); }}>
                  <Plus className="w-4 h-4" />
                  Adicionar Promoção
                </Button>
              </div>
              <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
                {(filteredPromotions || []).map((promotion) => (
                  <Card key={promotion.id} className="min-h-[200px] shadow-lg border-2 border-[#2E2E2E] bg-[#1F1F1F] hover:border-[#D4AF37] transition-all group">
                    <CardHeader className="pb-2">
                      <div className="flex justify-between items-start gap-4">
                        <div className="flex-1">
                          <CardTitle className="text-xl font-bold text-[#FFFFFF] group-hover:text-[#D4AF37] transition-colors">{promotion.name}</CardTitle>
                          <CardDescription className="text-[#CFCFCF] mt-1">{promotion.description}</CardDescription>
                          <div className="flex gap-2 mt-2">
                            <Button
                              variant="ghost"
                              size="icon"
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="space-y-1">
                          {promotion.products.map((product) => (
                            <div key={product.id} className="text-sm font-medium text-[#FFFFFF]">
                              {product.name}
                            </div>
                          ))}
                        </div>
            ...
            <TabsContent value="doses">
              <div className="flex flex-col sm:flex-row sm:justify-between mb-4 gap-2">
                ...
                <Button className="flex items-center gap-2 w-full sm:w-auto bg-[#D4AF37] hover:bg-[#E6C76A] text-[#0B0B0B]" onClick={() => { resetForm(); setIsDoseDialogOpen(true); }}>
                  <Plus className="w-4 h-4" />
                  Adicionar Dose
                </Button>
              </div>
              <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
                {(filteredDoses || []).map((dose) => (
                  <Card key={dose.id} className="min-h-[200px] shadow-lg border-2 border-[#2E2E2E] bg-[#1F1F1F] hover:border-[#D4AF37] transition-all group">
                    <CardHeader className="pb-2">
                      <div className="flex justify-between items-start gap-4">
                        <div className="flex-1">
                          <CardTitle className="text-xl font-bold text-[#FFFFFF] group-hover:text-[#D4AF37] transition-colors">{dose.name}</CardTitle>
                          <CardDescription className="text-[#CFCFCF] mt-1">{dose.description}</CardDescription>
                          <div className="flex gap-2 mt-2">
                            <Button
                              variant="ghost"
                              size="icon"
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="space-y-1">
                          {dose.items.map((item) => (
                            <div key={item.id} className="flex items-center gap-2 text-sm">
                              <span className="font-medium text-[#FFFFFF]">{item.product.name}</span>
                              <span className="text-[#CFCFCF]">({item.quantity}{item.product.isFractioned ? 'ml' : ''})</span>
                            </div>
                          ))}
                        </div>
                      </div>
            ...
            <TabsContent value="offers">
              <div className="flex flex-col sm:flex-row sm:justify-between mb-4 gap-2">
                ...
                <Button onClick={() => handleOpenOfferDialog()} className="bg-[#D4AF37] hover:bg-[#E6C76A] text-[#0B0B0B]">Nova Oferta</Button>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filteredOffers.map(offer => (
                  <Card key={offer.id} className="relative bg-[#1F1F1F] border border-[#2E2E2E]">
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2 text-[#FFFFFF]">
                        {offer.name}
                        <span className={`text-xs px-2 py-1 rounded ${offer.active ? 'bg-[#D4AF37] text-[#0B0B0B]' : 'bg-[#2E2E2E] text-[#CFCFCF]'}`}>{offer.active ? 'Ativa' : 'Inativa'}</span>
                      </CardTitle>
                      <CardDescription className="text-[#CFCFCF]">{offer.description}</CardDescription>
                    </CardHeader>
                    <CardContent>
