...
const AdminBackup = () => {
  ...
  return (
    <AdminLayout>
      <div className="p-6">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-element-black">Backup do Banco de Dados</h1>
          <p className="text-element-black/70 mt-2">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <h4 className="font-semibold text-element-black">Dados de Usuários</h4>
                  <ul className="text-sm text-element-black/70 space-y-1">
                ...
                <div className="space-y-2">
                  <h4 className="font-semibold text-element-black">Dados de Produtos</h4>
                  <ul className="text-sm text-element-black/70 space-y-1">
                ...
                <div className="space-y-2">
                  <h4 className="font-semibold text-element-black">Dados de Vendas</h4>
                  <ul className="text-sm text-element-black/70 space-y-1">
                ...
                <div className="space-y-2">
                  <h4 className="font-semibold text-element-black">Configurações</h4>
                  <ul className="text-sm text-element-black/70 space-y-1">
