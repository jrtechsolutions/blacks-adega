...
export default function AdminStockEntries() {
  ...
  return (
    <div className="flex h-screen bg-element-gray">
      <AdminLayout>
      <div className="flex-1 p-8 overflow-y-auto">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-2xl font-bold mb-6 text-element-black">Entradas de Estoque</h1>
          <Card className="mb-8">
            <CardHeader>
            ...
            <CardContent>
              <form className="grid grid-cols-1 md:grid-cols-2 gap-4" onSubmit={handleSubmit}>
                ...
                <div className="md:col-span-2 flex justify-end">
                  <Button type="submit" disabled={loading} className="bg-element-black hover:bg-element-black/90">
