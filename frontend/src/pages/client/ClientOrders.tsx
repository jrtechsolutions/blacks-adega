    ...
    <div className="min-h-screen bg-[#0B0B0B] pt-16 md:pt-0">
      ...
      <div className="lg:pl-64 min-h-screen w-full">
        <div className="p-4 md:p-6 lg:p-8 w-full">
          <h1 className="text-2xl md:text-3xl font-bold text-element-black mb-6">Meus Pedidos</h1>
                  ...
                  <CardContent className="pb-4">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      ...
                      <div className="flex flex-col items-end">
                        <div className="text-lg font-bold text-element-black">
                          R$ {order.total.toFixed(2)}
                        </div>
                        <Button 
                          variant="ghost" 
                          size="sm" 
                          className="text-element-black"
              ...
              {selectedOrder && (
                <>
                  <div className="flex-1 overflow-y-auto px-6 py-2 space-y-6">
                    ...
                    <div className="flex items-center gap-3 p-4 rounded-md bg-element-gray border">
                      {getOrderStatusInfo(selectedOrder.status).icon}
                      <span className="font-medium text-lg text-element-black">
