    ...
    <div className="min-h-screen bg-element-gray pt-16 md:pt-0">
      ...
      <div className="lg:pl-64 min-h-screen">
        <div className="p-4 md:p-6 lg:p-8">
          <h1 className="text-2xl md:text-3xl font-bold text-element-black mb-6">
            Seu Carrinho
          </h1>
          ...
          {cart.length === 0 ? (
            <div className="text-center py-12">
              ...
              <Button 
                ...
                className="bg-element-gold text-element-black hover:bg-element-gold/90"
              >
                Ver catálogo
              </Button>
            </div>
                                ...
                                return (
                                  <div key={doseId} className="border rounded-md mb-4 bg-gray-50">
                                    <div className="flex items-center justify-between p-4 border-b">
                                      <div>
                                        <h3 className="font-bold text-element-black">{doseInfo.name}</h3>
                                        <span className="text-xs text-gray-500">Dose personalizada</span>
                                      </div>
                                      <div className="flex items-center gap-2">
                                        <span className="font-bold text-lg text-element-black">R$ {doseInfo.price.toFixed(2)}</span>
                              ...
                              {Object.entries(combos).map(([comboId, items]) => {
                                ...
                                return (
                                  <div key={comboId} className="border rounded-md mb-4 bg-gray-50">
                                    <div className="flex items-center justify-between p-4 border-b">
                                      <div>
                                        <h3 className="font-bold text-element-black">{comboName}</h3>
                                        <span className="text-xs text-gray-500">Combo personalizado</span>
                                      </div>
                                      <div className="flex items-center gap-2">
                                        <span className="font-bold text-lg text-element-black">R$ {comboPrice.toFixed(2)}</span>
                                        <Button variant="ghost" size="sm" className="text-red-500 hover:text-red-700 hover:bg-red-50" onClick={() => {
                                          items.forEach(i => removeFromCart(i.id));
                                        }}>
                                          <Trash2 className="h-4 w-4 mr-1" /> Remover
                                ...
                                return (
                                  <div key={item.id} className="flex items-center py-4 border-b last:border-b-0">
                                    ...
                                    <div className="flex-1">
                                      ...
                                      <p className="font-bold text-element-black">
                ...
                <Card className="sticky top-4">
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-6">
                      ...
                      <Button 
                        className="w-full bg-element-gold text-element-black hover:bg-element-gold/90"
                        size="lg"
                        onClick={checkout}
                      >
                        Finalizar Pedido
      ...
      {showPixModal && (
        <Dialog open={showPixModal} onOpenChange={setShowPixModal}>
          <DialogContent>
            ...
            <div className="flex items-center gap-2 bg-element-white rounded p-2 select-all">
            ...
            <div className="flex justify-end gap-2 mt-4">
              ...
              <Button onClick={handlePixConfirm} className="bg-element-gold text-element-black hover:bg-element-gold/90">Já paguei</Button>
            </div>
          </DialogContent>
        </Dialog>
      )}
