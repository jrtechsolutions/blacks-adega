  ...
  return (
    <div className="element-card p-4 element-card-hover">
      ...
      <div className="flex justify-between items-end">
        <div>
          <p className="font-bold text-lg text-element-black">{price}</p>
...
const ClientDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0B] pt-16 md:pt-0">
      <ClientSidebar />
      ...
      <div className={`lg:pl-64 min-h-screen w-full`}>
        <div className="p-4 md:p-6 lg:p-8 w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-element-black mb-2">Olá, {user?.name || 'Cliente'}!</h1>
              ...
              <div className="relative">
                <Link to="/cliente-carrinho">
                  <Button variant="outline" size="icon" className="rounded-full bg-white">
                    ...
                    {cartCount > 0 && (
                      <span className="absolute -top-1 -right-1 bg-element-gold rounded-full w-4 h-4 flex items-center justify-center text-[10px]">
                        {cartCount}
                      </span>
                    )}
                  </Button>
          ...
          {/* Banner */}
          <div className="element-card p-6 md:p-8 mb-8 bg-gradient-to-r from-element-black to-element-gray-dark text-white">
