...
const ClientCatalog = () => {
  ...
  const renderProductCard = (product: Product) => {
    ...
    return (
      <Card key={product.id} className={`overflow-hidden transition-shadow ${isOutOfStock ? 'opacity-60 grayscale pointer-events-none' : 'hover:shadow-lg'}`}>
        <div className="relative h-48 flex items-center justify-center bg-element-white">
          <img 
        ...
        <CardContent className="p-4">
          ...
          <div className="flex justify-between items-center">
            <div>
              <p className="font-bold text-lg text-element-black">R$ {product.price.toFixed(2)}</p>
              {product.oldPrice && (
                <p className="text-sm text-element-black/60 line-through">
            ...
            <Button 
              ...
              variant="outline" 
              size="icon" 
              className="rounded-full hover:bg-element-gold hover:text-white"
  ...
  const renderCategoryButton = (category: any) => {
    ...
    return (
      <Button
        ...
        className={`flex items-center justify-center gap-2 transition-all duration-200 ${isActive ? 'bg-element-black text-white shadow-md' : 'bg-element-white'}`}
      >
  ...
  return (
    <div className="min-h-screen bg-element-gray pt-16 md:pt-0">
      <ClientSidebar />
      ...
      <div className="lg:pl-64 min-h-screen">
        <div className="p-4 md:p-6 lg:p-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <h1 className="text-2xl md:text-3xl font-bold text-element-black mb-4 md:mb-0">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Button
                variant="outline"
                size="icon"
                className="rounded-full bg-element-white relative"
                onClick={() => navigate('/cliente-carrinho')}
              >
                <ShoppingCart className="h-5 w-5" />
                {cart.length > 0 && (
                  <span className="absolute -top-1 -right-1 bg-element-gold rounded-full w-5 h-5 flex items-center justify-center text-[10px] text-white">
            ...
            {categoryLoading ? (
              <div className="text-center py-12">
                <div className="max-w-md mx-auto">
                  <div className="w-16 h-16 bg-element-gray rounded-full flex items-center justify-center mx-auto mb-4 animate-pulse-soft">
                    <Package className="h-8 w-8 text-element-black" />
                  </div>
                  <h3 className="text-lg font-semibold text-element-black mb-2">
                    Carregando produtos...
                  </h3>
                  <p className="text-element-black/70">
              ...
              <div className="text-center py-12">
                <div className="max-w-md mx-auto">
                  <div className="w-16 h-16 bg-element-gray rounded-full flex items-center justify-center mx-auto mb-4">
                    <Package className="h-8 w-8 text-element-black" />
                  </div>
                  <h3 className="text-lg font-semibold text-element-black mb-2">
                    Nenhum produto encontrado
                  </h3>
                  <p className="text-element-black/70 mb-6">
                    {searchTerm 
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  {searchTerm && (
                    <Button 
                      ...
                      className="text-element-black hover:text-element-black/80"
                    >
                      Limpar busca
                    </Button>
                  )}
